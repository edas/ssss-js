// MPZ object with utility functions for BigInt operations
...
const mpz = {
  ...
  ORDER_MSB: true, // +1 in GMP
  ORDER_LSB: false, // -1 in GMP
  ENDIAN_MSB: 1,
  ENDIAN_LSB: -1,
  ENDIAN_HOST: 0, // Not supported
  ...
  */
  import (orderMSB, endian, buf) {
    ...
    if (buf.BYTES_PER_ELEMENT === 1) {
      ...
      const littleEndian = (endian === this.ENDIAN_LSB)
   ...
   */
  export (orderMSB, size, endian, val) {
    val = BigInt(val)
    val = val < 0n ? -val : val
